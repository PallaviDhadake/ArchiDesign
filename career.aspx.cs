...
public partial class career : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            strMail.Append("You have a new Enquiry at Archi Desgin, <br/>");
            ...
            c.SendMail("info@intellect-systems.com", "Archi Architectures And Interiors", "armaheshk@gmail.com", strMail.ToString(), "New Enquiry at Archi Architectures And Interiors About Career", "", true, resumepath, fileName);

            //errMsg = c.ErrNotification(1, "Thank you for your enquiry. We will contact you soon.");

            ScriptManager.RegisterClientScriptBlock(this, GetType(), "myScript", "TostTrigger('success', 'Thank you for your interest in Archi Design and for sending us your resume.We appreciate the time you took to apply for our vacancy. We will contact you soon.');", true);
