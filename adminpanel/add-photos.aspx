<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/MasterAdmin.master" AutoEventWireup="true" CodeFile="add-photos.aspx.cs" Inherits="adminpanel_add_photos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style>
		...
		.titlecolor{color:#5f3232; font-size:20px; font-weight:600;}
    </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2 class="pgTitle">Add Photos </h2>
    <span class="titlecolor"><%= projtitle %></span> 
